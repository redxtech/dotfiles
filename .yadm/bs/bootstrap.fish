...
set -l PACKAGES_BASE 'cmake cowsay docker docker-compose fish fzf gitflow-avh htop libwebp neofetch neovim openssh p7zip pacaur pakku pkgfile rclone rsync thefuck time tldr wget yadm-git yay'
