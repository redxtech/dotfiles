# Generated by Powerlevel10k configuration wizard on 2021-06-21 at 12:56 MDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|helm|kubens|kubectx|kubecolor|oc|istioctl|kogito|k9s|helmfile|fluxctl|stern'
  ...
  function prompt_dir_git_prefix() {
    p10k segment -f 4 -t '{'
  }
  function prompt_dir_git_suffix() {
    p10k segment -f 4 -t '}'
  }
  # instant prompt versions
  function instant_prompt_dir_git_prefix {
    prompt_dir_git_prefix
  }
  function instant_prompt_dir_git_suffix {
    prompt_dir_git_suffix
  }
