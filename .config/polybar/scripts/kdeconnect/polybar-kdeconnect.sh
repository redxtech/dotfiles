...
# source: https://github.com/haideralipunjabi/polybar-kdeconnect
...
COLOR_NEWDEVICE='#ffff00'       # New Device
COLOR_BATTERY_90='#50fa7b'      # Battery >= 90
COLOR_BATTERY_80='#50fa7b'      # Battery >= 80
COLOR_BATTERY_70='#6272a4'      # Battery >= 70
COLOR_BATTERY_60='#6272a4'      # Battery >= 60
COLOR_BATTERY_50='#6272a4'      # Battery >= 50
COLOR_BATTERY_40='#f1fa8c'      # Battery >= 40
COLOR_BATTERY_30='#f1fa8c'      # Battery >= 30
COLOR_BATTERY_20='#ffb86c'      # Battery >= 20
COLOR_BATTERY_LOW='#ff5555'     # Battery <  20
