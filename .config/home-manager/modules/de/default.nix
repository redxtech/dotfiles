...

{
  ...
  xdg.mimeApps = {
    ...
    associations.added = {
      ...
      "image/svg+xml" = ["feh.desktop" "nvim.desktop" "sublime_text.desktop" "vivaldi-stable.desktop"];
      "application/xml" = ["nvim.desktop" "sublime_text.desktop"];
      "text/plain" = ["nvim.desktop" "sublime_text.desktop"];
      "text/html" = ["vivaldi-stable.desktop" "nvim.desktop" "sublime_text.desktop"];
      "application/javascript" = ["nvim.desktop" "sublime_text.desktop"];
      "application/json" = ["org.gnome.TextEditor.desktop" "sublime_text.desktop" "nvim.desktop"];
      ...
      "application/x-shellscript" = ["nvim.desktop" "kitty-open.desktop" "sublime_text.desktop"];
